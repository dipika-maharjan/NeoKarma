        ...
        <div className="w-full max-w-[345px]">
          ...
          {success ? (
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              <p className="text-[12px] font-medium leading-5 text-[#68706d]">
              ...
              <div className="pt-2 text-center">
                <Link
                  href="/login"
                  className="inline-flex items-center gap-1.5 text-[11px] font-extrabold text-[#0A3D25] no-underline hover:underline"
                >
                  <ArrowLeft size={12} />
                  {t('backToLogin')}
                </Link>
