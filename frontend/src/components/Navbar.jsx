...
const Navbar = () => {
  ...
  return (
    <nav
      className={`sticky top-0 z-50 w-full px-4 py-3.5 font-sans transition-all duration-300 md:px-8 ${scrolled
          ...
          {[
            ...
            return (
              <Link
                key={key}
                href={path}
                className={`text-[14px] font-medium transition-all duration-200 relative py-1 px-0.5 cursor-pointer no-underline ${isActive
          ...
          {isAuthenticated && user ? (
            <>
              ...
              <div className="relative group">
                <div className={`flex items-center gap-1.5 px-3.5 py-1.5 rounded-full border shadow-sm select-none transition-all duration-300 ${displayedStreak > 0
                  ? 'bg-[#0A3D25] text-white border-[#0A3D25]'
